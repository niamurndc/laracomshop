...
@section('admincontent')
  ...
  <form action="/admin/product/update/{{$product->id}}" method="post" class="col-md-6" enctype="multipart/form-data">
  @csrf
    ...
    <div class="form-group">
      ...
      <textarea name="body" id="body" rows="10" class="form-control">{{$product->description}}</textarea>
    </div>
